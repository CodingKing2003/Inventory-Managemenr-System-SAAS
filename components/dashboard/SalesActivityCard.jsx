...
const SalesActivityCard = ({item}) => {
  return (
    <Link href={item.href}  className="shadow rounded-lg border border-slate-200 transition-all duration-300 hover:border-blue-400 bg-white px-3 py-4 cursor-pointer flex items-center flex-col gap-3">
